      ...
      {generatedReading && (
        <Card title="Generated Reading">
          <div className="space-y-4">
            {/* Metadata */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 pb-4 border-b border-dark-200">
              <div>
                <p className="text-xs sm:text-sm text-dark-600">Metal Grade</p>
                <p className="text-base sm:text-lg font-bold font-mono text-dark-900">
                  {generatedReading.metalGrade}
                </p>
              </div>
              <div>
                <p className="text-xs sm:text-sm text-dark-600">Deviation %</p>
                <p className="text-base sm:text-lg font-bold text-primary-600">
                  {generatedReading.deviationPercentage}%
                </p>
              </div>
              <div>
                <p className="text-xs sm:text-sm text-dark-600">Temperature</p>
                <p className="text-base sm:text-lg font-bold text-dark-900">
                  {generatedReading.temperature}°C
                </p>
              </div>
              <div>
                <p className="text-xs sm:text-sm text-dark-600">Pressure</p>
                <p className="text-base sm:text-lg font-bold text-dark-900">
            ...
            {/* Composition */}
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-dark-900 mb-2 sm:mb-3">
                Composition
              </h3>
                  ...
                  <div className="grid gap-2 sm:gap-3">
                    {generatedReading.appliedDeviations.map(
                      (deviation, index) => (
                        <div
                          key={index}
                          className="flex flex-col sm:flex-row sm:items-center justify-between p-3 bg-yellow-50 border border-yellow-200 rounded-lg gap-2"
                        >
