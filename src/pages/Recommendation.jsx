...
const Recommendation = () => {
  ...
  const handleGetAIExplanation = async () => {
    ...
    try {
      ...
      // Get the analysis message from the result
      const analysisNotes = result.aiAnalysis?.alloyRecommendation?.notes || "";

      // Combine analysis notes with Gemini explanation
      const combinedExplanation = analysisNotes
